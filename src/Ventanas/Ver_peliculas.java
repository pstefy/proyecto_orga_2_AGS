 ...
 * @author Stefani
 */
public class Ver_peliculas extends javax.swing.JFrame {

    /**
     * Creates new form Ver_peliculas
     */
    public static Principal principal_5;
    public Ver_peliculas(Principal princ) {
        initComponents();
        principal_5 = princ;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ver_peliculas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ver_peliculas(principal_5).setVisible(true);
            }
        });
    }
